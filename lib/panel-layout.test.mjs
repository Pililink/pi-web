...
test("uses the Codex 600px default while respecting available shell width", () => {
  assert.equal(getDefaultRightPanelWidth(700), 348);
  assert.equal(getDefaultRightPanelWidth(1366), 600);
  assert.equal(getDefaultRightPanelWidth(1920), 600);
});
