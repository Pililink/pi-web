...
test("detects temporary pi-cwd projects and partitions them from regular projects", async () => {
  const {
  ...
  assert.equal(isTemporaryProjectRoot("/home/u/pi-cwd-20260803"), true);
  assert.equal(isTemporaryProjectRoot("C:\\Users\\u\\pi-cwd-20260803"), true);
  ...
  const partitioned = partitionSidebarProjects([
    ...
    { root: "/home/u/pi-cwd-20260803", sessions: [session({ id: "t-new", modified: "2026-08-03T13:00:00.000Z" })], latestActivity: "2026-08-03T13:00:00.000Z", manual: true },
    { root: "/home/u/pi-cwd-20260802", sessions: [session({ id: "t-old", modified: "2026-08-02T13:00:00.000Z" })], latestActivity: "2026-08-02T13:00:00.000Z", manual: true },
  ]);
  ...
  assert.deepEqual(partitioned.temporary.map((group) => group.root), [
    "/home/u/pi-cwd-20260803",
    "/home/u/pi-cwd-20260802",
  ]);
  assert.deepEqual(
