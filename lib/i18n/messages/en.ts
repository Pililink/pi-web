...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.removeProjectBody": "This will permanently delete all chats in this project. This cannot be undone.",
    "sidebar.removeProjectConfirm": "Delete all chats",
    "sidebar.removingProject": "Deleting…",
