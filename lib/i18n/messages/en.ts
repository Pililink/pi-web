...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "layout.hideRightPanel": "Hide side panel",
    "layout.showRightPanel": "Show side panel",
    "layout.toggleRightPanel": "Show/hide side panel",
    "layout.expandPanel": "Expand panel",
    "layout.restorePanelWidth": "Restore panel width",
    "layout.closePanel": "Close panel",
    "panelHome.aria": "Side panel views",
    "panelHome.review": "Review",
    "panelHome.terminal": "Terminal",
    "panelHome.browser": "Browser",
    ...
    "summary.unpin": "Unpin summary",
    "summary.toggle": "Toggle pinned summary",
    "summary.environment": "Environment",
    "summary.changes": "Changes",
    "summary.local": "Local",
    "summary.branches": "Branches",
    "summary.sideChats": "Side chats",
    "summary.sources": "Sources",
    "panelHome.comingSoon": "Coming soon",
    "panelHome.filesNeedProject": "Select a project to browse files",
    "panelHome.sideChatNeedSession": "Open a session to use Side Chat",
    "panelHome.reviewPlaceholder": "Review is not available yet",
    "panelHome.reviewHint": "Code review tools will land here. Use Files or Side Chat for now.",
    "sidebar.new": "New",
    ...
    "sidebar.clearChats": "Clear chats",
    "sidebar.clearChatsTitle": "Clear chats in {name}?",
    "sidebar.clearChatsBody": "This will permanently delete all chats in this project. The empty project will remain in the sidebar.",
    "sidebar.clearChatsConfirm": "Clear chats",
    "sidebar.clearingChats": "Clearing…",
    "sidebar.clearChatsError": "Failed to clear chats",
    "sidebar.clearChatsEmpty": "No chats to clear",
    "sidebar.removeProject": "Remove project",
    "sidebar.removeProjectTitle": "Remove {name}?",
    "sidebar.removeProjectBody": "This will permanently delete all chats in this project and remove the project from the sidebar. This cannot be undone.",
    "sidebar.removeProjectConfirm": "Remove project",
    "sidebar.removingProject": "Removing…",
    "sidebar.removeProjectError": "Failed to remove project",
    "sidebar.projectsSection": "Projects",
    "sidebar.temporarySection": "Recent",
    ...
    "sidebar.sortPriorityHint": "Needs input and unread chats first",
    "sidebar.sortUpdated": "Last updated",
    "sidebar.sortManual": "Manual order",
    "sidebar.addProject": "Add new project",
    "sidebar.newRecentChat": "New chat",
    "sidebar.projectOptions": "Project sidebar options",
    "sidebar.sectionCollapse": "Collapse",
    "sidebar.sectionExpand": "Expand",
    "sidebar.noChats": "No chats",
    "sidebar.expandSessions": "Show more",
    ...
    "files.breadcrumbAria": "File path",
    ...
    "sideChat.actions": "Side Chat actions",
    "sideChat.refork": "Refork",
    "sideChat.reforkTitle": "Recreate from the main chat's latest point",
    "sideChat.clear": "Clear",
    "sideChat.clearTitle": "Start an empty Side Chat",
    "sideChat.opening": "Opening Side Chat…",
    "sideChat.openPrompt": "Open Side Chat to create an independent conversation.",
    "sideChat.loadingSession": "Loading session…",
        "sideChat.working": "Working…",
    "sideChat.placeholder": "Ask Side Chat…",
    "sideChat.readonly": "Read-only",
    "sideChat.readonlyTitle": "Switch to read-only tools",
    "sideChat.edit": "Edit",
    "sideChat.editTitle": "Allow file edits in this side chat",
    "sideChat.expiredTitle": "Side chat expired",
    "sideChat.expiredDescription": "This temporary side chat is no longer available; start a new side chat to continue.",
    "sideChat.startNew": "Start new side chat",
    "sideChat.sendFromComposer": "Send to Side Chat",
    "sideChat.emptyHint": "Independent side conversation. History is not copied — use peek_main for main-thread progress.",
