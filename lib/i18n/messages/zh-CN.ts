...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "layout.toggleSidebar": "显示/隐藏侧边栏",
    "layout.hideRightPanel": "隐藏右侧面板",
    "layout.showRightPanel": "显示右侧面板",
    "layout.toggleRightPanel": "显示/隐藏右侧面板",
    "layout.expandPanel": "展开面板",
    "layout.restorePanelWidth": "恢复面板宽度",
    "layout.closePanel": "关闭面板",
    "panelHome.aria": "侧边面板视图",
    "panelHome.review": "审阅",
    "panelHome.terminal": "终端",
    "panelHome.browser": "浏览器",
    "panelHome.files": "文件",
    ...
    "summary.pin": "固定摘要",
    "summary.unpin": "取消固定",
    "summary.toggle": "显示/隐藏固定摘要",
    "summary.environment": "环境信息",
    "summary.changes": "变更",
    "summary.local": "本地",
    "summary.branches": "分支",
    "summary.sideChats": "侧边聊天",
    "summary.sources": "来源",
    "panelHome.comingSoon": "即将推出",
    "panelHome.filesNeedProject": "请先选择项目以浏览文件",
    "panelHome.sideChatNeedSession": "请先打开会话以使用侧边聊天",
    "panelHome.reviewPlaceholder": "审阅功能尚未就绪",
    "panelHome.reviewHint": "代码审阅工具将放在这里。目前可使用文件或侧边聊天。",
    "sidebar.new": "新建",
    ...
    "sidebar.clearChats": "清空会话",
    "sidebar.clearChatsTitle": "清空 {name} 的会话？",
    "sidebar.clearChatsBody": "将永久删除该项目下的所有聊天内容。空项目会保留在侧边栏。",
    "sidebar.clearChatsConfirm": "清空会话",
    "sidebar.clearingChats": "清空中…",
    "sidebar.clearChatsError": "清空会话失败",
    "sidebar.clearChatsEmpty": "没有可清空的会话",
    "sidebar.removeProject": "移除项目",
    "sidebar.removeProjectTitle": "移除 {name}？",
    "sidebar.removeProjectBody": "将永久删除该项目下的所有聊天内容，并从侧边栏移除该项目。此操作无法恢复。",
    "sidebar.removeProjectConfirm": "移除项目",
    "sidebar.removingProject": "移除中…",
    "sidebar.removeProjectError": "移除项目失败",
    "sidebar.projectsSection": "项目",
    "sidebar.temporarySection": "最近",
    "sidebar.recentSection": "最近",
    "sidebar.organizeSidebar": "整理侧边栏",
    "sidebar.byProject": "按项目",
    "sidebar.inOneList": "在一个列表中",
    "sidebar.sortChatsBy": "Sort chats by",
    "sidebar.sortPriority": "优先级",
    "sidebar.sortPriorityHint": "需要输入和未读会话优先",
    "sidebar.sortUpdated": "最近更新",
    "sidebar.sortManual": "手动排序",
    "sidebar.addProject": "添加本地项目",
    "sidebar.newRecentChat": "新对话",
    "sidebar.projectOptions": "项目侧边栏选项",
    "sidebar.sectionCollapse": "折叠",
    "sidebar.sectionExpand": "展开",
    "sidebar.noChats": "没有聊天",
    "sidebar.expandSessions": "展开显示",
    ...
    "sideChat.actions": "侧边聊天操作",
    "sideChat.refork": "重建",
    "sideChat.reforkTitle": "从主会话最新节点重新创建",
    "sideChat.clear": "清空",
    "sideChat.clearTitle": "开启空白侧边聊天",
    "sideChat.opening": "正在打开侧边聊天…",
    "sideChat.openPrompt": "打开侧边聊天以创建独立对话。",
    "sideChat.loadingSession": "正在加载会话…",
        "sideChat.working": "处理中…",
    "sideChat.placeholder": "向侧边聊天提问…",
    "sideChat.readonly": "只读",
    "sideChat.readonlyTitle": "切换为只读工具",
    "sideChat.edit": "可编辑",
    "sideChat.editTitle": "允许在此侧边聊天中修改文件",
    "sideChat.expiredTitle": "侧边聊天已过期",
    "sideChat.expiredDescription": "此临时侧边聊天已不可用；请新建一个侧边聊天继续。",
    "sideChat.startNew": "新建侧边聊天",
    "sideChat.sendFromComposer": "发送到侧边聊天",
    "sideChat.emptyHint": "独立侧边对话。不会复制主会话历史，可用 peek_main 查看主线程进度。",
